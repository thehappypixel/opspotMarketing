...
import { trackFormSubmit, trackLinkClick } from "../utils/analytics";
...
// Interactive contact form. Hydrated as a client:load island. It is also
// server-rendered, so the <h1> and copy are present in the raw HTML for SEO.
      ...
      <h1 className="text-xl leading-tight font-bold text-gray-900 text-center">
        ...
        <div className="flex justify-center">
          <p className="pt-6 mb-6 text-md tracking-wider leading-snug font-normal text-gray-700 text-center md:w-3/4 lg:w-1/2">
            If have questions, need support, or are interested in learning more,
