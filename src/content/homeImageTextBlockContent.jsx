...
const HomeImageTextBlockContent = [
  {
    firstItem: "text",
    header: "Mobile guard",
    body: "Simplified task management and patrol for enhanced security. Guards can complete their patrol tours and checkpoints through a interfance that's so intutive, they won't require training.",
  ...
  },
  {
    ...
    ctaLink: "/incident-reporting",
    ctaText: "Incident reporting",
