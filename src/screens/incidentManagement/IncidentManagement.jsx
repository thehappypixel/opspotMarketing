...
function IncidentManagementScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>Incident Management Software - Fast, Accurate Field Incident Reporting | Opspot</title>
        <meta 
          name="description" 
        ...
        <meta property="og:title" content="Incident Management Software - Fast, Accurate Field Incident Reporting | Opspot" />
        <meta property="og:description" content="Empower your security team with fast, accurate field incident reporting. Customizable reports with photos and GPS tracking." />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content={`${siteUrl}/incident-management`} />
        <meta property="twitter:title" content="Incident Management Software - Fast, Accurate Field Incident Reporting | Opspot" />
        <meta property="twitter:description" content="Empower your security team with fast, accurate field incident reporting. Customizable reports with photos and GPS tracking." />
      </Helmet>
      <Navigation />
